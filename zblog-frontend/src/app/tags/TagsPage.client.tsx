...
// Dynamically import TagCard
const TagCard = nextDynamic(
  () => import("@/components/tags/TagCard"),
  { ssr: false }
);
  ...
  return (
    <main className="bg-slate-900 text-white min-h-screen pt-8 pb-16 overflow-hidden">
      <section className="max-w-7xl mx-auto px-4 md:px-8">
        {/* Header */}
        <div ref={containerRef} className="relative mb-10 min-h-[6rem] flex items-center overflow-visible">
          {/* Animated Tag Icon */}
          <motion.div
