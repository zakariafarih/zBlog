(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_932382e2._.js", {
...
"[project]/node_modules/oidc-client-ts/dist/esm/oidc-client-ts.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/react-oidc-context/dist/esm/react-oidc-context.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$oidc$2d$client$2d$ts$2f$dist$2f$esm$2f$oidc$2d$client$2d$ts$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/oidc-client-ts/dist/esm/oidc-client-ts.js [app-client] (ecmascript)");
;
var AuthContext = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].createContext(void 0);
...
var UserManagerImpl = typeof window === "undefined" ? null : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$oidc$2d$client$2d$ts$2f$dist$2f$esm$2f$oidc$2d$client$2d$ts$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UserManager"];
var AuthProvider = (props)=>{
    ...
    const [userManager] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useState({
    ...
    const [state, dispatch] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useReducer(reducer, initialAuthState);
    const userManagerContext = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useMemo({
        "AuthProvider.useMemo[userManagerContext]": ()=>Object.assign({
                settings: userManager.settings,
                events: userManager.events
            }, Object.fromEntries(userManagerContextKeys.map({
                "AuthProvider.useMemo[userManagerContext]": (key)=>{
                    var _a, _b;
                    return [
                        key,
            ...
            }["AuthProvider.useMemo[userManagerContext]"])), Object.fromEntries(navigatorKeys.map({
                "AuthProvider.useMemo[userManagerContext]": (key)=>[
                        key,
                        userManager[key] ? ({
                            "AuthProvider.useMemo[userManagerContext]": async (args)=>{
                                dispatch({
                                    type: "NAVIGATOR_INIT",
                                    method: key
                                });
                        ...
                        })["AuthProvider.useMemo[userManagerContext]"] : unsupportedEnvironment(key)
                    ]
            }["AuthProvider.useMemo[userManagerContext]"])))
    }["AuthProvider.useMemo[userManagerContext]"], [
        userManager
    ]);
    const didInitialize = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useRef(false);
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useEffect({
        "AuthProvider.useEffect": ()=>{
            ...
            const handleUserLoaded = {
                "AuthProvider.useEffect.handleUserLoaded": (user)=>{
                    dispatch({
                        type: "USER_LOADED",
                        user
                    });
            ...
            const handleUserSignedOut = {
                "AuthProvider.useEffect.handleUserSignedOut": ()=>{
                    dispatch({
            ...
            const handleSilentRenewError = {
                "AuthProvider.useEffect.handleSilentRenewError": (error)=>{
                    dispatch({
                        type: "ERROR",
                        error: renewSilentError(error)
                    });
                }
            }["AuthProvider.useEffect.handleSilentRenewError"];
    ...
    const removeUser = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useCallback({
        "AuthProvider.useCallback[removeUser]": async ()=>{
            if (!userManager) unsupportedEnvironment("removeUser");
            await userManager.removeUser();
            if (onRemoveUser) await onRemoveUser();
        }
    }["AuthProvider.useCallback[removeUser]"], [
        userManager,
        onRemoveUser
    ]);
...
var useAutoSignin = ({ signinMethod = "signinRedirect" } = {})=>{
    const auth = useAuth();
    const [hasTriedSignin, setHasTriedSignin] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useState(false);
    const shouldAttemptSignin = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useMemo({
        "useAutoSignin.useMemo[shouldAttemptSignin]": ()=>!hasAuthParams() && !auth.isAuthenticated && !auth.activeNavigator && !auth.isLoading && !hasTriedSignin
    }["useAutoSignin.useMemo[shouldAttemptSignin]"], [
...
var withAuthenticationRequired = (Component, options = {})=>{
    ...
    const C = (props)=>{
        ...
        return auth.isAuthenticated ? /* @__PURE__ */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].createElement(Component, {
            ...props
        }) : OnRedirecting();
    };
    C.displayName = displayName;
...
//# sourceMappingURL=node_modules_932382e2._.js.map